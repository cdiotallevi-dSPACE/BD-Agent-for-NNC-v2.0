...
**Design document version:** `1.5.0`  
**Runtime compatibility tag:** `1.5`  
**Date:** `2026-08-04`
...
query_budget_allocation:
  direct_nnc_and_deployment: 0.35
  use_case_led_discovery: 0.30
  engineering_publisher_discovery: 0.20
  research_patent_careers_and_other: 0.15
```

The implementation MAY rebalance unused slots, but it SHALL reserve at least 25%
of executable general-web queries for use-case-led discovery.
...
23. adapt prompt ownership and substantive validation;
24. adapt report wording while retaining Version 1.26 layout;
25. run unit and integration tests;
26. run controlled example companies;
27. compare artifacts against this specification;
28. document every deviation.
