...
37. Create tests for every mandatory requirement in this specification.
38. Record implementation deviations in `docs/IMPLEMENTATION_NOTES.md`.
...
The `ddgs` package is mandatory because Version 1.14 requires real execution of
text-search queries.
...
minimum web-evidence-count gate is introduced in Version 1.14.
...
Version 1.14 SHALL use the following provider and discovery combination by
default:
...
No provider outside this set SHALL be enabled by default in Version 1.14.
...
Version 1.14 broadens collection but does not require a minimum accepted
...
There is no default “skip completed companies” policy in Version 1.14.
...
`--reprocess-existing-ratings` SHALL NOT be used in Version 1.14.
...
selected `Y` row is the default Version 1.14 behavior.
...
## 40. Version 1.14 Runtime, Model, Domain, and Regression Controls

### 40.1 Authoritative Production Models

Version 1.14 defines the following production models:
...
The active Version 1.14 models remain:
...
## 42. Version 1.14 Directory, Workbook, and Cycle-Selection Contract

### 42.1 Authoritative Changes

Version 1.14 makes these three changes authoritative:
...
`Companies.xlsx`; legacy binary `.xls` format is not part of Version 1.14.

---

## 43. Version 1.14 Model Assignment Contract

### 43.1 Authoritative Model Assignments

Version 1.14 fixes the production model assignments as follows:
...
`qwen3:8b` is not part of the Version 1.14 production design.
...
### 44.1 Root Cause Addressed by Version 1.14
...
Version 1.14 treats this condition as an incomplete implementation, not a
...
OCR is not mandatory for Version 1.14, but silent ingestion of an empty
...
### 45.1 Root Cause Addressed by Version 1.14
...
Version 1.14 defines this as an incomplete search implementation.
...
Version 1.14 SHALL not introduce a minimum accepted-evidence-count gate.
...
## 46. Version 1.14 Cost-Free Search Configuration and Quota Enforcement
...
The following are conservative software caps for the Version 1.14
configuration:
...
CODER has completed the Version 1.14 search configuration only when:
...
## 47. Version 1.14 Gemma Runtime and Assessment-Report Contract
...
Version 1.14 addresses the narrative path without changing the authority of the
deterministic assessment.
...
CODER has completed Version 1.14 only when:
...
## 48. Version 1.14 Provider Credentials and PDF Presentation Contract
