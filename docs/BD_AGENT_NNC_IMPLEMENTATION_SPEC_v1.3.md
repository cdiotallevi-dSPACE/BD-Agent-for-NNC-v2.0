...
19. adapt prompt ownership and substantive validation;
20. adapt report wording while retaining Version 1.26 layout;
21. run unit and integration tests;
22. run controlled example companies;
23. compare artifacts against this specification;
24. document every deviation.
