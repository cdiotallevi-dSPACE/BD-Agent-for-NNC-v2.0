...
26. Create tests for every mandatory requirement in this specification.
27. Record implementation deviations in `docs/IMPLEMENTATION_NOTES.md`.
...
The `ddgs` package is mandatory because Version 1.12 requires real execution of
text-search queries.
...
minimum web-evidence-count gate is introduced in Version 1.12.
...
Version 1.12 SHALL use the following provider and discovery combination by
default:
...
No provider outside this set SHALL be enabled by default in Version 1.12.
...
Version 1.12 broadens collection but does not require a minimum accepted
...
There is no default “skip completed companies” policy in Version 1.12.
...
`--reprocess-existing-ratings` SHALL NOT be used in Version 1.12.
...
selected `Y` row is the default Version 1.12 behavior.
...
## 40. Version 1.12 Runtime, Model, Domain, and Regression Controls

### 40.1 Authoritative Production Models

Version 1.12 defines the following production models:
...
The active Version 1.12 models remain:
...
## 42. Version 1.12 Directory, Workbook, and Cycle-Selection Contract

### 42.1 Authoritative Changes

Version 1.12 makes these three changes authoritative:
...
`Companies.xlsx`; legacy binary `.xls` format is not part of Version 1.12.

---

## 43. Version 1.12 Model Assignment Contract

### 43.1 Authoritative Model Assignments

Version 1.12 fixes the production model assignments as follows:
...
`qwen3:8b` is not part of the Version 1.12 production design.
...
### 44.1 Root Cause Addressed by Version 1.12
...
Version 1.12 treats this condition as an incomplete implementation, not a
...
OCR is not mandatory for Version 1.12, but silent ingestion of an empty
...
### 45.1 Root Cause Addressed by Version 1.12
...
Version 1.12 defines this as an incomplete search implementation.
...
Version 1.12 SHALL not introduce a minimum accepted-evidence-count gate.
...
## 46. Version 1.12 Cost-Free Search Configuration and Quota Enforcement
...
The following are conservative software caps for the Version 1.12
configuration:
...
CODER has completed the Version 1.12 search configuration only when:
