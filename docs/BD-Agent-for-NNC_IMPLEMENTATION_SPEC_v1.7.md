...
29. adapt prompt ownership and substantive validation;
30. adapt report wording while retaining Version 1.26 layout;
31. run unit and integration tests;
32. run controlled example companies;
33. compare artifacts against this specification;
34. document every deviation.
