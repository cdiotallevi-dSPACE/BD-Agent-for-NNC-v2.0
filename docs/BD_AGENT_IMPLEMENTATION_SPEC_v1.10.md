...
Open data/Companies.xlsx from the configured application root
  -> validate installation, Ollama models, and mandatory portfolio-index dependencies
...
There is no default “skip completed companies” policy in Version 1.10.
...
`--reprocess-existing-ratings` SHALL NOT be used in Version 1.10.
...
selected `Y` row is the default Version 1.10 behavior.
...
## 40. Version 1.10 Runtime, Model, Domain, and Regression Controls

### 40.1 Authoritative Production Models

Version 1.10 defines the following production models:
...
The active Version 1.10 models remain:
...
## 42. Version 1.10 Directory, Workbook, and Cycle-Selection Contract

### 42.1 Authoritative Changes

Version 1.10 makes these three changes authoritative:
...
`Companies.xlsx`; legacy binary `.xls` format is not part of Version 1.10.

---

## 43. Version 1.10 Model Assignment Contract

### 43.1 Authoritative Model Assignments

Version 1.10 fixes the production model assignments as follows:
...
`qwen3:8b` is not part of the Version 1.10 production design.
...
### 44.1 Root Cause Addressed by Version 1.10
...
Version 1.10 treats this condition as an incomplete implementation, not a
...
OCR is not mandatory for Version 1.10, but silent ingestion of an empty
