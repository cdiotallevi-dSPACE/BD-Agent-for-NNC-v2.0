...
There is no default “skip completed companies” policy in Version 1.8.
...
`--reprocess-existing-ratings` SHALL NOT be used in Version 1.8.
...
selected `Y` row is the default Version 1.8 behavior.
...
## 40. Version 1.8 Runtime, Model, Domain, and Regression Controls

### 40.1 Configurable Local Model Profile

The production design SHALL not hard-code a 27B Local LLM.

Version 1.8 SHALL use a configurable, benchmark-selected, quantized
...
## 42. Version 1.8 Directory, Workbook, and Cycle-Selection Contract

### 42.1 Authoritative Changes

Version 1.8 makes these three changes authoritative:
...
`Companies.xlsx`; legacy binary `.xls` format is not part of Version 1.8.
