...
**Design document version:** `1.6.0`  
**Runtime compatibility tag:** `1.6`  
**Date:** `2026-08-04`
...
18. **patented applied-ML discovery** using company legal names, brands,
    validated patent assignees, broad ML/model terms, use-case terms, and
    patent-host-restricted queries.
...
The implementation MAY rebalance unused slots, but it SHALL reserve at least 25%
of executable general-web queries for use-case-led discovery and at least 15%
for patented applied-ML discovery. A normal company scan SHALL execute at least
six independent patent queries unless the patent family is explicitly disabled
for a documented company type.
...
candidate_selection_diversity:
  minimum_if_available:
    ...
    target_company_patent_candidates: 3
  maximum_share:
...
26. adapt prompt ownership and substantive validation;
27. adapt report wording while retaining Version 1.26 layout;
28. run unit and integration tests;
29. run controlled example companies;
30. compare artifacts against this specification;
31. document every deviation.
